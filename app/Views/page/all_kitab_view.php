...
<body class="homepage px-[40px]">
    <div class="container container flex flex-col p-0 mb-20">
        <!-- Display the table with the data from the shahih_muslim table -->
        <table class="table rounded-full border border-grey justify-center mb-10">
            <thead class="border border-grey">
                <tr>
                    <th class="p-4 border border-grey">Kitab</th>
                    <th class="p-4">Hadits</th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($alld as $row) : ?>
                    <tr>
                        <td class="p-4 w-[15%] border border-grey">
                            <?php
                            switch ($row['kitab']) {
                                case 'shahih_muslim':
                                    echo 'Shahih Muslim';
                        ...
                        <td class="p-4 border border-grey"><?= $row['arab']; ?></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
        ...
        <container class="flex flex-end relative justify-center flex-gap-3 w-max-lg"><?= $pager->links('group7', 'custom1'); ?></container>
    </div>
</body>
