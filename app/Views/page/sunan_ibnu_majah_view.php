...
<head>
  ...
  use App\Controllers\Sunan_Ibnu_Majah;
...
<body class="homepage px-[40px]">
  <div class="container container flex flex-col p-0">
    <!-- Display the table with the data from the sunan_ibnu_majah table -->
          ...
          <tr>
            ...
            <td class="p-4">
              ...
              foreach ($words as $word) {
                $removedDiacritics = Sunan_Ibnu_Majah::removeDiacritics($word);
                ...
                if ($stemmedSelectedWord !== null && $stemmedWord === $stemmedSelectedWord) {
                  ...
                  echo '<a href="' . base_url('/page/sunan_ibnu_majah_view/?highlight=' . $word) . '">' . Sunan_Ibnu_Majah::removeDiacritics($highlightedWord) . '</a> ';
                ...
                } elseif (Sunan_Ibnu_Majah::isMarifah($word)) {
                  echo '<a class="text-gray-500 text-decoration-line: underline" href="' . base_url('/page/sunan_ibnu_majah_view/?highlight=' . $word) . '">' . $removedDiacritics . '</a> ';
                } else {
        ...
        <container class="grid w-[100%] grid-cols-2 grid-rows-1 gap-4 items-center">
          ...
          <div class="text-left py-4">
            <div class="p-2 w-full max-w-[50%] h-[100%] text-white font-semibold rounded-md bg-gold opacity-75">
              ...
              if ($stemmedWord == '') {
                ...
                $stemmedWord = Sunan_Ibnu_Majah::removeDiacritics($stemmedWord);
                $splitWord = mb_str_split($stemmedWord);
                $splitWord = implode(' ', $splitWord);
                ?>
                  <div>
                  <?php echo '<p>Kata yang dipilih : ' . Sunan_Ibnu_Majah::removeDiacritics($selectedWord);
                  echo '</p>'; ?>
                  </div>
                  <div>
                    <?php
          ...
          <div class=" text-right">
            <button class="p-2 text-white font-semibold rounded-md transition duration-150 bg-gold"
              onclick="window.location.href = '<?= base_url('/page/sunan_ibnu_majah_view') ?>'">
              Clear Filter
            </button>
          </div>
