...
class Sunan_Nasai extends BaseController
{
    ...
    {
        // Remove diacritics
        $word = Sunan_Nasai::removeDiacritics($word);
    ...
    {
        // Load the SunanNasai using dependency injection
        ...
        $nasa = $model->paginateFiltered($selectedWord, 10, 'group4'); // 10 records per page, 'group1' is the pagination group
