...
class Sunan_Tirmidzi extends BaseController
{
    ...
    {
        // Remove diacritics
        $word = Sunan_Tirmidzi::removeDiacritics($word);
    ...
    {
        // Load the SunanTirmidzi using dependency injection
        ...
        $tirm = $model->paginateFiltered($selectedWord, 10, 'group3'); // 10 records per page, 'group1' is the pagination group
