...
class Sunan_Ibnu_Majah extends BaseController
{
    ...
    {
        // Remove diacritics
        $word = Sunan_Ibnu_Majah::removeDiacritics($word);
    ...
    {
        // Load the SunanIbnuMajah using dependency injection
        ...
        $maja = $model->paginateFiltered($selectedWord, 10, 'group6'); // 10 records per page, 'group1' is the pagination group
